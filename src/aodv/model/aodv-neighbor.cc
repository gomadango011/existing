...
//隣接ノード情報を取得
std::vector<Ipv4Address> Neighbors::GetNeighborList ()
{
  //printf("隣接リスト取得\n");
  Purge ();
  ...
  {
  auto neighbor = m_nb.at(i);
  Ipv4Address neighborid = neighbor.m_neighborAddress;
  IpList.push_back(neighborid);
  }
