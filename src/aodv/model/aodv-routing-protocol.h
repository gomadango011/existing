...
private:
  ...
  void RecvWHC(Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src);

  void RecvWHE(Ptr<Packet> p, Ipv4Address receiver, Ipv4Address src);
  //\}
  ...
  std::vector<Ipv4Address> WH_List;
