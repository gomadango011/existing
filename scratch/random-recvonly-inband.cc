...
AodvExample::Configure (int argc, char **argv)
{
  ...
  cmd.AddValue ("destination_only",
              "AODV RREQ DestinationOnly flag / DestinationOnly behavior (true/false)",
              destinationOnly);
...
AodvExample::CreateNodes ()
{
  ...
  fixedpositionAlloc->Add(Vector(end_distance - WH_size - 90, 400, 0));  //WH1の位置情報　ID:1
  fixedpositionAlloc->Add(Vector(end_distance - 90, 400, 0));  //WH2の位置情報            ID:2
